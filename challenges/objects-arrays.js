...
//Complete the following requests WITHOUT using any array methods like 
...
const largerPopulation = [];
 largerPopulation.push(zooAnimals.filter(e => e.population < 5));
...
const populationTotal = [];
 ...
 populationTotal.push (zooAnimals.reduce((acc, curr) => {
